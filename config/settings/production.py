"""
Production settings for Simple File Uploader project.
...
# Use Whitenoise to serve static files_uploads
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='Simple File Uploader <noreply@example.com>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[Simple File Uploader]')
